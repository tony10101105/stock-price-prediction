...
urls = []
url1 = r"https://www.wsj.com/search/term.html?KEYWORDS=US&min-date=2010/01/01&max-date=2019/12/31&isAdvanced=true&daysback=90d&andor=AND&sort=date-desc&source=wsjarticle,press,newswire,wsjpro&page="
search_dict = {
    "US":url1,
}
...
with open("output_us4.csv","w",newline = "",encoding = "utf-8",errors="ignore") as f:
    writer = csv.writer(f)
